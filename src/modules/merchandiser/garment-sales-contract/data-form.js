...
export class DataForm {
  ...
  DeliveryOptions = ["BY SEA", "BY AIR", "BY SEA-AIR", "BY TRUCK", "BY EXPEDITION"];
  ...
  selectedROChanged(newValue, oldValue) {
    ...
    if (newValue) {
      ...
      if(newValue.Id){
        ...
        //this.data.Price=newValue.ConfirmPrice.toLocaleString('en-EN', { minimumFractionDigits: 4}); 14-05-2020
  ...
  PriceChanged(e){
    //this.data.Price=parseFloat(e.srcElement.value).toLocaleString('en-EN', { minimumFractionDigits: 4}); 14-05-2020
    //this.data.Amount=parseFloat(this.data.Quantity*parseFloat(this.data.Price)).toLocaleString('en-EN', { minimumFractionDigits: 2}); 14-05-2020
