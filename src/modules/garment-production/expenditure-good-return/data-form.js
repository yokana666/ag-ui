...
export class DataForm {
    ...
    get roLoader() {
        return (keyword) => {
            var info = {
              keyword: keyword,
              filter: JSON.stringify({UnitId: this.data.Unit.Id, ExpenditureType: this.data.ReturType})
            };
    ...
    selectedReturnTypeChanged(newValue){
        this.selectedRO = null;
        this.data.RONo = null;
        this.data.Article = null;
        this.data.Comodity = null;
    ...
    async selectedROChanged(newValue, oldValue){
        ...
        if(newValue) {
            ...
            Promise.resolve(this.service.getExpenditureGood({ filter: JSON.stringify({ RONo: this.data.RONo, UnitId: this.data.Unit.Id, ExpenditureType: this.data.ReturType}) }))
                    .then(result => {
